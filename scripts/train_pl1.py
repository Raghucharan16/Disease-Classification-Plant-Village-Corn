...
def main():
    ...
    print("Loader sizes (should match your folder counts):")
    print("  len(train_dataset) =", len(dl_tr.dataset))
    print("  len(val_dataset)   =", len(dl_va.dataset), flush=True)
